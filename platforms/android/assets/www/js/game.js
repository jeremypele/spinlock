$(function(){
    ...
    function Circle(position){
      ...
      // Distance from center = index * (circle width + circles espacement)
    ...
    $(document).on("game.spacebar", function (e) {
      ...
      for (var i = 0; i < circles_array.length; i++) {   
        ...
        for (var j = i + 1; j < circles_array.length; j++) {
          ...
          if (circle_angle_1 - circle_angle_2 < 12 && circle_angle_1 - circle_angle_2 > -12 && circle_angle_1 - circle_angle_2 !== 0) {
    ...
    function debugState(){
      ...
      for (var i = 0; i < circles_array.length; i++) {   
        ...
        for (var j = i + 1; j < circles_array.length; j++) {
          ...
          console.log(circle_angle_1 , circle_angle_2, circle_angle_1 - circle_angle_2)
